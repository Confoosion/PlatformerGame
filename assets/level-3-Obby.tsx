...
<tileset version="1.10" tiledversion="1.10.2" name="level-3-Obby" tilewidth="128" tileheight="128" tilecount="121" columns="11">
 <image source="spritesheet_retina.png" width="1408" height="1408"/>
 <tile id="5">
  <properties>
   <property name="hiddenLevel" type="bool" value="true"/>
  </properties>
 </tile>
 <tile id="76">
  <properties>
