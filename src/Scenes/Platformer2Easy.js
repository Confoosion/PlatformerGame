class Platformer2Easy extends Phaser.Scene {
    constructor() {
        super("platformerScene2E");
    ...
    create() {
        ...
        this.map = this.add.tilemap("level-2E-platform", 64, 64, 40, 20);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        //this.tileset = this.map.addTilesetImage("kenny_tilemap_packed", "tilemap_tiles");
        this.tileset = this.map.addTilesetImage("level-2E", "tiles");
        this.objectTileset = this.map.addTilesetImage("level-2E-Obby", "tiles");
        ...
        my.sprite.player = this.physics.add.sprite(75, 100, "character2").setScale(0.5);
        ...
        this.physics.add.overlap(my.sprite.player, this.doorGroup, (obj1, obj2) => {
            if(this.gemsCollected >= 5)
            {
                ...
                this.scene.start("platformerScene3E");
            }
        });
