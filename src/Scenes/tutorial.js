class tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        this.map = this.add.tilemap("tutorial", 64, 64, 40, 20);

        // // Add a tileset to the map
        // // First parameter: name we gave the tileset in Tiled
        // // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        // //this.tileset = this.map.addTilesetImage("kenny_tilemap_packed", "tilemap_tiles");
        this.tileset = this.map.addTilesetImage("tut-tiles", "tiles");
        this.objectTileset = this.map.addTilesetImage("tut-tiles-Obby", "tiles");
        ...
        this.tutorialText2 = this.add.text(900, 800, "Press shift to dash", { fontSize: "32px", fill: "#FFF" });
        this.tutorialText2.setOrigin(0.5);

        this.tutorialText3 = this.add.text(1450, 700, "WATCH OUT FOR THE SAW!!!", { fontSize: "32px", fill: "#FFF" });
        this.tutorialText3.setOrigin(0.5);

        this.tutorialText4 = this.add.text(2000, 450, "Collect gems!", { fontSize: "32px", fill: "#FFF" });
        this.tutorialText4.setOrigin(0.5);

        this.tutorialText5 = this.add.text(2000, 500, "You need at least 5 gems to go to the next level", { fontSize: "32px", fill: "#FFF" });
        this.tutorialText5.setOrigin(0.5);
