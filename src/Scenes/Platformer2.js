class Platformer2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.map = this.add.tilemap("level-2-platform", 64, 64, 40, 20);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        //this.tileset = this.map.addTilesetImage("kenny_tilemap_packed", "tilemap_tiles");
        this.tileset = this.map.addTilesetImage("level-2", "tiles");
        this.objectTileset = this.map.addTilesetImage("level-2-Obby", "tiles");
        ...
        my.sprite.player = this.physics.add.sprite(75, 250, "character2").setScale(0.5);
