class Platformer3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.map = this.add.tilemap("level-3-platform", 64, 64, 40, 20);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        //this.tileset = this.map.addTilesetImage("kenny_tilemap_packed", "tilemap_tiles");
        this.tileset = this.map.addTilesetImage("level-3", "tiles");
        this.objectTileset = this.map.addTilesetImage("level-3-Obby", "tiles");
        ...
        this.secret = this.map.createFromObjects("Doors", {
            name: "secret",
            key: "Doors",
            frame: 5
        });
        ...
        this.physics.add.overlap(my.sprite.player, this.secretGroup, (obj1, obj2) => {
            this.sound.play("doorEnter");
            this.scene.start("platformerSceneS");
        });
